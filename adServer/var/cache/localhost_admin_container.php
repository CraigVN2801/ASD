...
class ReviveAdserverCachedContainer extends Container
{
    ...
    {
        return $this->services['filesystem'] = new \League\Flysystem\Filesystem(new \League\Flysystem\Adapter\Local('C:\\xampp\\htdocs\\adServer\\www\\images', 0));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'webpath.admin' => 'localhost/adServer/www/admin',
            'webpath.delivery' => 'localhost/adServer/www/delivery',
            'webpath.deliverySSL' => 'localhost/adServer/www/delivery',
            'webpath.images' => 'localhost/adServer/www/images',
            'webpath.imagesSSL' => 'localhost/adServer/www/images',
            ...
            'file.xmlrest' => 'ax.php',
            'store.mode' => '0',
            'store.webDir' => 'C:\\xampp\\htdocs\\adServer\\www\\images',
            'store.ftpHost' => '',
            'store.ftpPath' => '',
            'store.ftpUsername' => '',
            'store.ftpPassword' => '',
            ...
            'delivery.secret' => 'nt6BsNZ0HpHQKgff0Ugwd30n9Xl3qGpmTvPnPVZsZus=',
            ...
            'email.qmailPatch' => '',
            'email.fromName' => '',
            'email.fromAddress' => 'craigvn2801@gmail.com',
            'email.fromCompany' => '',
