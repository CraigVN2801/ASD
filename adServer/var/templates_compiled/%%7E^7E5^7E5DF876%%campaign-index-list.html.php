<?php /* Smarty version 2.6.18, created on 2024-04-04 10:45:05
         compiled from campaign-index-list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'campaign-index-list.html', 20, false),array('function', 'rv_add_session_token', 'campaign-index-list.html', 44, false),array('function', 'ox_column_class', 'campaign-index-list.html', 92, false),array('function', 'ox_column_title', 'campaign-index-list.html', 93, false),array('function', 'cycle', 'campaign-index-list.html', 149, false),array('function', 'ox_campaign_icon', 'campaign-index-list.html', 160, false),array('function', 'ox_entity_id', 'campaign-index-list.html', 164, false),array('function', 'ox_campaign_status', 'campaign-index-list.html', 167, false),array('function', 'ox_campaign_type', 'campaign-index-list.html', 170, false),array('function', 'ox_column_updated', 'campaign-index-list.html', 173, false),array('modifier', 'count', 'campaign-index-list.html', 113, false),array('modifier', 'escape', 'campaign-index-list.html', 160, false),)), $this); ?>
...
'><?php echo ((is_array($_tmp=$this->_tpl_vars['campaign']['campaignname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
                ...
                <td class='alignRight verticalActions'>
                  <?php if ($this->_tpl_vars['campaign']['system'] != true): ?>
                    <ul class='rowActions'>
                        <?php if ($this->_tpl_vars['canAddBanner']): ?>
                        <li>
