<?php /* Smarty version 2.6.18, created on 2024-04-20 00:29:31
...
<ul id="oaNavigationTabs" class="seductive-menu">
...
?>
          ...
          <?php else: ?>
              <li class="seductive <?php if ($this->_sections['n']['first']): ?> first<?php else: ?><?php if ($this->_sections['n']['last']): ?> last<?php endif; ?><?php endif; ?><?php if ($this->_tpl_vars['aMainTabNav'][$this->_sections['n']['index_prev']]['selected']): ?> after-active<?php endif; ?>">
          <?php endif; ?>
              <div class="sensual-left"><div class="enticing-right">
...
" class="alluring-link"><?php echo ((is_array($_tmp=$this->_tpl_vars['aMainTabNav'][$this->_sections['n']['index']]['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a>
              </div></div>
          </li>
      <?php endfor; endif; ?>
