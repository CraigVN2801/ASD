<?php /* Smarty version 2.6.18, created on 2024-04-20 00:41:37
         compiled from layout/main.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'layout/main.html', 15, false),array('insert', 'OA_Admin_UI_CustomHeader', 'layout/main.html', 87, false),array('insert', 'OA_Admin_UI_CustomFooter', 'layout/main.html', 190, false),array('function', 't', 'layout/main.html', 100, false),)), $this); ?>
...
"<?php endif; ?>><head>
  <title><?php echo ((is_array($_tmp=$this->_tpl_vars['pageTitle'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</title>
...
unset($_smarty_tpl_vars);
 ?>
  ...
  '; ?>
      ...
      color: <?php echo ((is_array($_tmp=$this->_tpl_vars['headerForegroundColor'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
;
  <?php echo '
  }
  '; ?>
  ...
  '; ?>
      ...
      background-color: <?php echo ((is_array($_tmp=$this->_tpl_vars['headerBackgroundColor'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
;
  <?php echo '
  }
  '; ?>
  ...
  '; ?>
      ...
      color: <?php echo ((is_array($_tmp=$this->_tpl_vars['headerTextColor'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
  ...
  <script>
      window.rvZxcvbn = <?php echo $this->_tpl_vars['jsonZxcvbn']; ?>
;
  </script>
...
unset($_smarty_tpl_vars);
 ?>
  ...
  <?php if ($this->_tpl_vars['maintenanceSecurityCheck']): ?>
  <script>
      RV_securityCheck('<?php echo ((is_array($_tmp=$this->_tpl_vars['adminWebPath'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'js') : smarty_modifier_escape($_tmp, 'js')); ?>
');
  </script>
  <?php endif; ?>
